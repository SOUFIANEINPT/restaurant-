...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Creat Table') }}</div>
                  <div class="card-body">
                    <form method="POST" action="{{route('table.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Nombrechaire" type="number" class="form-control{{ $errors->has('Nombrechaire') ? ' is-invalid' : '' }}" name="Nombrechaire" min="4" max="6" value="{{ old('numbershaire') }}" required>

                                @if ($errors->has('Nombrechaire'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="picture" type="url" class="form-control{{ $errors->has('picture') ? ' is-invalid' : '' }}" name="picture" required>
